...
public class CopyTask extends AsyncTask<Void, Void, Boolean> {
	...
	protected Boolean doInBackground(Void... params) {
		...
		filename = Environment.getExternalStorageDirectory().getAbsolutePath()+ "/xdictionary/dict/";
	...
	protected void onPostExecute(Boolean result) {
		if (result) {
			Toast.makeText(c, "Finished copying dictionary data", Toast.LENGTH_LONG).show();
		}
	}
